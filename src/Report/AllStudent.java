...
public class AllStudent extends javax.swing.JInternalFrame {
    ...
    private void bindingProvince() {
        try {
            ...
            while (rs.next()) {
                pro.add(rs.getString("provinceID"));
                cmbprovince.addItem(rs.getString("provinceName"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void print(String condition) {
        try {
            ...
            parameter.put("province", cmbprovince.getSelectedItem());
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(730, 90));
        jPanel1.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        cmbprovince.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
        cmbprovince.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ທັງໝົດ" }));
        cmbprovince.setPreferredSize(new java.awt.Dimension(300, 50));
        cmbprovince.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cmbprovinceItemStateChanged(evt);
            }
        });
        jPanel1.add(cmbprovince);

        jPanel3.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 20, 0, 0, new java.awt.Color(242, 242, 242)));
        ...
        btnPrint.setPreferredSize(new java.awt.Dimension(77, 50));
        ...
        btnExport.setPreferredSize(new java.awt.Dimension(180, 26));
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        if (row > 0) {
            if (cmbprovince.getSelectedItem().equals("ທັງໝົດ")) {
                print("/Report/AllStudent.jrxml");
            } else {
                print("/Report/student.jrxml");
            }
        } else {
