...
public class StudentWithRisidence extends javax.swing.JInternalFrame {
    ...
    private void print() {
        try {
            InputStream path = getClass().getResourceAsStream("/Report/student2.jrxml");
            JasperReport jreport = JasperCompileManager.compileReport(path);
            Map<String, Object> parameter = new HashMap<>();
            parameter.put("student", cmbStay.getSelectedItem());
    ...
    private void initComponents() {
        ...
        cmbStay.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cmbStayItemStateChanged(evt);
            }
        });
        jPanel2.add(cmbStay);

        jPanel3.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 20, 0, 0, new java.awt.Color(242, 242, 242)));
        jPanel3.setPreferredSize(new java.awt.Dimension(500, 26));
    ...
    private void cmbStayItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbStayItemStateChanged
        int index = cmbStay.getSelectedIndex();
        if (index != -1) {
            try {
                ClearTable();
                ...
                cst.setString(1, cmbStay.getSelectedItem().toString());
    ...
    }//GEN-LAST:event_cmbStayItemStateChanged
